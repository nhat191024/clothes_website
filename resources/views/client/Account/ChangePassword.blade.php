        ...
        <div class="row my-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item active-list"><a href="{{ route('client.account.changepassword') }}">Change password</a></li>
                            <li class="list-group-item "><a href="{{ route('client.account.PurchaseHistory') }}">Purchase
                                    history</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-8 ">
                <form action="{{ route('client.account.changepassword') }}" method="POST">
                    ...
                    <input class="account-input" type="password" name="passwordCurrent"

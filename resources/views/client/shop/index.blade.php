...
@section('main')
 ...
 <section class="shop spad">
                ...
                <div class="shop__sidebar">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="card">
                                    <div class="card-heading">
                                        <a data-toggle="collapse" data-target="#collapse-{{ $pCateg->id }}">{{ $pCateg->name }}</a>
                                    </div>
                                    <div id="collapse-{{ $pCateg->id }}" class="collapse" data-parent="#accordionExample">
                                        <div class="card-body" >
                                            <ul id="categoryFilterItems">
                                                ...
                                                <li>
                                                    <label for="{{ $pCateg->id }}-{{ $cCateg->id }}">
                                                        <input type="checkbox" id="{{ $pCateg->id }}-{{ $cCateg->id }}" class="category-filter pointer" data-ParentCategory="{{ $pCateg->id }}" value="{{ $cCateg->id }}">
                                                        {{ $cCateg->name }}
                    ...
                    <div class="sidebar__filter">
                        ...
                        <div class="filter-range-wrap">
                            ...
                            data-min="{{$allProducts->min('price')}}" data-max="{{$allProducts->max('price')}}"
                            ></div>
                    ...
                    <div class="sidebar__color">
                        ...
                        <div class="size__list color__list">
                            ...
                            <label for="{{ $color->name }}" class="color-item {{ $loop->index >= 5 ? 'hidden' : '' }}">
                                {{ $color->name }}
    ...
    <link rel="stylesheet" href="{{ asset('css/shop/shop.css') }}"></link>

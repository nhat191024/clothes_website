        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each($bills, function (index, item) {
                    ...
                    billItem.find('#bill-phone').text(item.full_name+ ' · '+item.phone);
                    billItem.find('#order_date').text('Vào ' + convertDateTime(item.created_at) + ' · '+ getTimePassedBy(item.created_at));
